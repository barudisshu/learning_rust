...
//!
//! Imagine now that we live on planet XY140Z-n where the days of the week are numbered
//! from 0 to n (integer n > 0) and where I save from week number 0 to week number n
//! included (in the table below n = 6).
//!
